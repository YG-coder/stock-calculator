    ...
    return (
        <CalculatorPageTemplate config={config}>
            ...
            <section className="mt-14 space-y-6 text-sm text-slate-600 leading-relaxed border-t border-slate-200 pt-10">
                ...
                <p>미국주식 배당은 한국과 달리 분기 배당이 일반적이고 현지 원천징수세({US_DIVIDEND_WITHHOLDING.rateDisplay})가 자동으로 차감됩니다. 세전·세후 금액을 함께 계산해두면 실제 통장에 들어오는 배당 수입을 정확히 파악할 수 있어, 배당 투자 포트폴리오 설계에 도움이 됩니다.</p>
                ...
                <p>예시: 주당 배당금 2달러, 주가 50달러, 100주 보유 → 연 배당금 200달러, 배당수익률 4%, 원천징수세 {US_DIVIDEND_WITHHOLDING.rateDisplay} 적용 시 세후 {200 * (1 - US_DIVIDEND_WITHHOLDING.rate)}달러.</p>
