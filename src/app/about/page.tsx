      ...
      <main className="min-h-screen bg-slate-50 text-slate-900 pb-20">
        ...
        <div className="mx-auto max-w-5xl px-6 py-12 md:px-8">
          <div className="space-y-8">
            ...
            {/* 1-1. 운영 주체 */}
            <SectionCard>
              <Article title="운영 주체 안내">
                <p className="mt-2">
                  주식계산기.kr은 <strong>인컴랩</strong>이 개발하고 운영하는 서비스입니다.
                  개인 투자자들이 매매 과정에서 반복적으로 필요로 하는 계산(수익률,
                  평단가, 손절가, 세금 등)을 별도의 엑셀 작업 없이 빠르고 정확하게
                  처리할 수 있도록 돕기 위해 만들어졌습니다.
                </p>
                <p className="mt-3">
                  계산기에 반영되는 세율·공제 기준 등 공식 수치는 국세청, 금융기관
                  등이 고시하는 공식 자료를 참고해 반영하며, 관련 법령이나 정책이
                  개정되면 계산 기준도 함께 갱신합니다. 다만 세법 개정 시점에 따라
                  반영이 지연될 수 있으므로, 실제 신고·투자 판단 전에는 국세청
                  홈택스 등 공식 출처로 최신 기준을 다시 확인하시기 바랍니다.
                </p>
              </Article>
            </SectionCard>
            ...
            <SectionCard>
              <Article title="안내 및 면책">
                ...
                <p className="mt-3">
                  특히 세금 관련 계산 결과는 일반적인 기준을 바탕으로 한 참고
                  정보이며, 실제 신고·납부 금액은 개인의 상황에 따라 달라질 수
                  있습니다. 정확한 세액과 최신 세율은 국세청 홈택스 등 공식 자료를
                  확인하거나 세무사 등 전문가와 상담하시기 바랍니다.
                </p>
              </Article>
            </SectionCard>
            ...
            <SectionCard>
              <Article title="문의">
                <p className="mt-2">
                  주식계산기.kr은 인컴랩이 운영합니다. 오류 제보, 기능 요청, 제휴
                  문의는 아래 이메일로 연락해 주세요.
                </p>
                <p className="mt-4">
                  이메일:{" "}
