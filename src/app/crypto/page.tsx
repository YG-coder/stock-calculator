...
const calculators = [
    ...
    },
    {
        ...
        desc: "롱·숏 포지션의 실제 수익과 ROE를 계산합니다.",
...
export default function CryptoPage() {
    return (
        <main className="mx-auto max-w-5xl px-6 py-16">
            <h1 className="mb-6 text-3xl font-bold md:text-4xl">코인 계산기 모음</h1>
            ...
            <section className="mt-16 text-sm leading-relaxed text-slate-600">
                ...
                <p>
                    암호화폐 시장은 변동성이 크고 선물 거래에서는 레버리지를 자주 사용하기 때문에,
                    진입 전에 청산 가격과 실제 수익 구조를 정확하게 계산하는 것이 중요합니다.
