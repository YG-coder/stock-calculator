...
export const guidePages: Record<string, GuidePageConfig> = {
    ...
    "dividend-tax-basic": {
        ...
        intro:
            "배당금을 받으면 세금이 먼저 떼인 뒤 입금되는 경우가 많습니다. 배당소득세가 어떻게 매겨지는지 알면 명목 배당금과 실제 손에 들어오는 금액의 차이를 이해하고, 세후 실수령액을 가늠하기 쉬워집니다. 아래는 일반적인 구조를 정리한 참고용 안내이며, 세율과 적용 기준은 세법 개정에 따라 달라질 수 있으니 공식 자료로 확인하시기 바랍니다.",
        sections: [
            {
            ...
            },
            {
                ...
                paragraphs: [
                    ...
                    "다만 종합과세가 항상 세금을 크게 늘리는 것은 아닙니다. 본인의 다른 소득 규모에 따라 추가 세부담이 크지 않을 수도 있습니다. 또한 2026년부터는 일정 요건을 갖춘 고배당기업 배당소득에 대해 분리과세를 선택할 수 있는 제도가 도입되는 등 제도가 변화하고 있어, 본인에게 어떤 방식이 적용되는지는 최신 기준으로 확인할 필요가 있습니다.",
                ],
            },
            {
        ...
        faqs: [
            ...
            },
            {
                ...
                answer:
                    "배당소득 과세 방식은 세제 개편으로 변화하고 있습니다. 예를 들어 2026년부터 일정 요건의 고배당기업 배당에 분리과세가 도입되는 등 변동이 있으므로, 본인에게 적용되는 기준은 해당 연도의 공식 자료로 확인하는 것이 안전합니다.",
            },
        ],
        relatedCalculators: [
            {
