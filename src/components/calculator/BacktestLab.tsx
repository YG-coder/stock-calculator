...
const sample = "2.1, -1.2, 3.4, 0.8, -4.1, 5.2, 1.0, -0.5, 2.8, 1.7, -2.3, 4.0, 1.2, 0.6, -3.0, 2.4, 3.1, -1.8, 0.9, 2.0, -0.7, 1.5, 2.6, -2.1";
const won = (value: number) => new Intl.NumberFormat("ko-KR", { maximumFractionDigits: 0 }).format(value);

export default function BacktestLab() {
  const [returnsText, setReturnsText] = useState(sample);
